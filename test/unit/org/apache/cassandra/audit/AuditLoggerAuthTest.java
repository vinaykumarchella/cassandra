...
public class AuditLoggerAuthTest
{
    ...
    @Test
    public void testCqlCreateRoleAuditing() throws Throwable
    {
        createTestRole();
    }

    @Test
    public void testCqlALTERRoleAuditing() throws Throwable
    {
        createTestRole();
    ...
    @Test
    public void testCqlDROPRoleAuditing() throws Throwable
    {
        createTestRole();
    ...
    @Test
    public void testCqlLISTROLESAuditing() throws Throwable
    {
    ...
    @Test
    public void testCqlGRANTAuditing() throws Throwable
    {
        createTestRole();
    ...
    @Test
    public void testUNAUTHORIZED_ATTEMPTAuditing() throws Throwable
    {
        createTestRole();
