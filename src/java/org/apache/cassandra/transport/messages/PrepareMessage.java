    ...
    public Message.Response execute(QueryState state, long queryStartNanoTime)
    {
        ...
        try
        {
            ...
            if(auditLogEnabled)
            {
                ...
                auditEntry = auditLogManager.getEvent(parsedStmt.statement, query, state, AuditLogEntryType.PREPARE_STATEMENT);
            }
        ...
        {
            auditLogManager.log(auditEntry, state.getClientState(), e);
